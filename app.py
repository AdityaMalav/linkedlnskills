    ...
    for i in skills:
        ...
        if i in ['ISHA','ISHA KATARIA']:
            ...
            with col1:
                ...
                st.image( a, width=150)
            with col2:
                st.write(f"""#####  Sorry, [ {i}](https://www.linkedin.com/in/isha-kataria-2309/?originalSubdomain=in) is not a skill but She is a communications professional with an affinity for building relationships, She strive for excellence in the management of programmes in the field of art, culture, and education.............☺️""")
                break
